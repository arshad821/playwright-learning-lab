/*
========================================================
PLAYWRIGHT - E2E ORDER PLACEMENT
========================================================

Concepts Covered:
- fill() and click()
- Locator filtering with filter({ hasText })
- Dynamic product selection
- Web-first assertions
- toHaveText(), toHaveValue(), toContainText()
- pressSequentially() for auto-suggestion
- Dynamic Order ID extraction
- Filtering table rows by Order ID
- getByRole() for button identification
- waitFor() and locator chaining
- Manual iteration vs Playwright filter()
========================================================
*/
